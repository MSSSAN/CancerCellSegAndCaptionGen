...
> 
> **주제:** 유방암세포 현미경 이미지 input시 세포 종류별 segmentation mask 및 의학적 판독문을 자동 생성하는 프로그램 제작. 이를 통해 관련 의료진의 업무를 보조할 수 있는 시스템 구성. 
...
### 1-1) 웹앱 (HuggingFace 페이지를 제작해 호스팅 중으로, 실제 사용 가능합니다.)
 - HuggingFace 서버 상태에 따라 대기시간이 오래 걸릴 수 있습니다.(5~10분 가량)
 - 새 탭에서 열어 두시면, 일정 기간 후 프로그램이 자동 로드됩니다.
 - 페이지 하단의 'Download here'을 클릭해 테스트용 현미경 이미지 다운로드가 가능합니다.
