...
class U_Net(nn.Module):
    def __init__(self,img_ch=3,output_ch=1):
        ...
        self.Conv7 = conv_block(ch_in=1024,ch_out=2048)
        self.Conv8 = conv_block(ch_in=2048,ch_out=4096)

        self.Up8 = up_conv(ch_in=4096,ch_out=2048)
        self.Up_conv8 = conv_block(ch_in=4096, ch_out=2048)
...
class AttU_Net(nn.Module):
    def __init__(self,img_ch=3,output_ch=1):
        ...
        self.Up8 = up_conv(ch_in=4096,ch_out=2048)
        self.Att8 = Attention_block(F_g=2048,F_l=2048,F_int=1024)
        self.Up_conv8 = conv_block(ch_in=4096, ch_out=2048)
